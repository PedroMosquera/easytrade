---
description: Enable or disable an OTel Benchmark App problem pattern via the feature-flag-service API
argument-hint: "[pattern-name] [enable|disable]"
---

Toggle the OTel Benchmark App problem pattern given in $ARGUMENTS (a pattern name, and optionally
