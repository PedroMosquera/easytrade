---
description: Start OTel Benchmark App locally with Docker Compose and verify the stack is healthy with smoke tests against the REST APIs
argument-hint: "[start|start-all] (default: start-all)"
---

Start the local OTel Benchmark App stack and confirm it's healthy end to end.
