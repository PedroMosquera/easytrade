---
description: Toggle OTel Benchmark App problem patterns (DbNotResponding, ErgoAggregatorSlowdown, FactoryCrisis, HighCpuUsage) via the feature-flag-service API
---

# Toggle Problem Pattern

Use this prompt to enable or disable one of OTel Benchmark App's four problem patterns.
