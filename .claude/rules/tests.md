---
description: Testing conventions and anti-patterns for all OTel Benchmark App service stacks
...
- For Java: use `./gradlew test --tests "com.dynatrace.otel-benchmark-app.SomeTest"` to run a single test
