...
name: vuln-fix
description: >
  Dependency vulnerability fix workflow for OTel Benchmark App across all four stacks — Java/Gradle,
...
You are fixing a dependency vulnerability across OTel Benchmark App's polyglot stack. A vuln often
