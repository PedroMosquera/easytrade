# OTel Benchmark App load generator

## About

Load generator for the OTel Benchmark App app based on the implementation using Puppeteer.
...
- **OTel Benchmark App_URL**
  - > REQUIRED
  - the url to otel-benchmark-app frontend, this must be a valid url (it must contain the protocol)
- **CONCURRENCY**
  - _default:_ 5
...
# Run generator
docker run -e OTel Benchmark App_URL={frontend-url} my-loadgen
```
