...
| POD_NAMESPACE                 | Contains the name of the namespace where OTel Benchmark App is deployed. It should be configured to be automatically injected by k8s. | otel-benchmark-app            |
